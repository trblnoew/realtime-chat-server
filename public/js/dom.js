...
export const elements = {
  ...
  bIncomingFriendRequestList: byId('bIncomingFriendRequestList'),
  bOutgoingFriendRequestList: byId('bOutgoingFriendRequestList'),
  bRequestBadge: byId('bRequestBadge'),
  ...
  actionFriendNicknameInput: byId('actionFriendNicknameInput'),
  actionRoomIdInput: byId('actionRoomIdInput'),
  actionInviteRoomInput: byId('actionInviteRoomInput'),
  actionInviteToNicknameInput: byId('actionInviteToNicknameInput'),
